...
class TeamCreate extends Component
{
    ...
    {
        $this->team_form->setTeam(new TeamModel());
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            \Log::error('TeamEdit', ['line' => __LINE__, 'error' => $e->getMessage(), 'team_id' => $this->team_form->id, 'guid' => $errguid, 'validatedData' => $validatedData]);
