...
class ArticleCreate extends Component
{
    ...
    public function save()
    {
        ...
        if ($validatedData['image_upload'] && get_class($validatedData['imagine_upload']) === 'Livewire\\Features\\SupportFileUploads\\TemporaryUploadedFile'){
            $validatedData['image_upload'] ->store('assets/article', 's3');
            $validatedData['image'] = [
                'disk' => 's3',
                'extension' => $validatedData['image_upload']->getClientOriginalExtension(),
                'key' => 'asset/article/' . $validatedData['image_upload']->hashName(),
