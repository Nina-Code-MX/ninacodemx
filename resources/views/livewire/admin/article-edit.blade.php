<div>
    ...
    <h1 class="border-b border-neutral-300 font-semibold px-2 py-4 text-lg">{{ __('Editar') }} <span class="font-normal">({{ $article_form->id ?? '0' }}) {{ $article_form->name ?? 'Unknown' }}</span></h1>
