        ...
        <div class="container mx-auto">
            <div class="gap-4 grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="bg-neutral-100 flex gap-4 p-4 place-self-stretch rounded">
                    <div class="h-32 w-52">
                        <img alt="{{ $service['name'] }}" class="object-cover h-full rounded" src="{{ asset('images/logo-ninacode-mx-1024.png') }}" title="{{ $service['name'] }}" />
                    </div>

                    <div class="w-full">
                        <h3 class="mb-4">{{ $service['name'] }}</h3>

                        <p class="mb-4 place-self-stretch text-justify">{{ \Illuminate\Support\Str::of($service['description'])->words('50', '...') }}</p>
