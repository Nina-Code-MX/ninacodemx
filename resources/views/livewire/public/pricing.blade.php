...
@push('meta')
<meta name="description" content="{{ __('pages/pricing.meta.description') }}" />
<meta name="keywords" content="{{ __('pages/pricing.meta.keywords') }}" />
<meta name="title" content="{{ ($pageTitle ?? '') . ' - ' . env('APP_NAME', 'Laravel') }}" />
<meta property="og:title" content="{{ ($pageTitle ?? '') . ' - ' . env('APP_NAME', 'Laravel') }}" />
<meta property="og:description" content="{{ __('pages/pricing.meta.description') }}" />
...
<meta property="twitter:description" content="{{ __('pages/pricing.meta.description') }}" />
