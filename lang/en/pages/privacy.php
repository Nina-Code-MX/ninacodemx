...
return [
    ...
    'info' => [
        'h2' => 'Information that is Collected',
        'p' => [
    ...
    'usage' => [
        ...
        'p' => [
            ...
            'Nina Code is highly committed to fulfilling the commitment to keep your information secure. We use the most advanced systems and constantly update them to ensure that there is no unauthorized access.'
        ]
    ],
    'cookies' => [
        'h2' => 'Cookies',
    ...
    'personal' => [
        'h2' => 'Control of your Personal Information',
        'p' => [
            ...
            'Nina Code reserves the right to change the terms of this Privacy Policy at any time.'
        ]
    ]
];
