...
return [
    ...
    'warranty' => [
        'h2' => 'Política de Reembolso y Garantía',
        'p' => [
    ...
    'privacy' => [
        'h2' => 'Privacidad',
        'p' => [
            'Este sitio web www.ninacode.mx garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.',
            'La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.',
            'Nina Code reserva los derechos de cambiar o de modificar estos términos sin previo aviso.'
        ]
    ]
];
